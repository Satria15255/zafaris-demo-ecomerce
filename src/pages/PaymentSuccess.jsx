            ...
            {latestOrder ? (
                <div className="mb-8 p-4 flex flex-col rounded-lg ">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-4xl font-bold pb-6 text-green-600">Payment Success! 🎉</p>
                    </div>
                    {/* Order Details */}
                    ...
                    <div className="flex gap-4 md:justify-end md:items-center w-full">
                        ...
                        <button onClick={() => navigate(`/my-orders`)} className="text-lg font-semibold h-12 w-full md:w-1/5 border border-gray-300 rounded-xl hover:bg-black hover:text-white">
                            My Orders
                        </button>
                    </div>
                </div>
