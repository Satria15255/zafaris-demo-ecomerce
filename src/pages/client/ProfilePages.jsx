        ...
        <div className="flex flex-col  gap-10 lg:px-16 h-full">
            <div className="flex flex-col md:flex-row justify-center items-center gap-2 lg:px-16">
                ...
                <div className="w-60 flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs lg:text-sm bg-green-200 flex gap-1  px-2 w-40 justify-center items-center rounded-full"><MdCheckCircleOutline size={20}/>Verified Account</p>
                </div>
            </div>

            {/* User Details & Upate Form*/}
            <div className="w-full">
                <form onSubmit={handleUpdateForm} className="grid grid-cols-1 md:grid-cols-2 text-sm gap-7 md:gap-14 w-full px-2 lg:px-16">
                ...
                <div className="w-full flex justify-end lg:justify-center px-4 my-4 lg:my-10">
                    <button onClick={handleUpdateForm} className="bg-black w-1/2 lg:w-1/5 text-white border border-gray-300 hover:bg-white hover:text-black transition durationn-300 px-4 py-3 rounded-xl mt-4">Save Change</button>
                </div>
            </div>
        </div>
    )
