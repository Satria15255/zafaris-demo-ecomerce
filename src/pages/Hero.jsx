            ...
            <Swiper modules={[Autoplay, EffectFade]} effect="fade" autoplay={{ delay: 4000 }} loop className=" h-full">
                <SwiperSlide>
                    <div className="relative flex justify-center items-center">
                        ...
                        <div className="absolute inset-0 bg-black/30 flex flex-col gap-3 md:gap-3  items-center justify-center ">
                            <p className="text-3xl md:text-4xl lg:text-6xl text-white font-bold">NEW ERA OF MOTION</p>
                ...
                <SwiperSlide>
                    <div className="relative flex justify-center items-center">
                        ...
                        <div className="absolute inset-0 bg-black/30 flex flex-col gap-3 md:gap-3 items-center justify-center">
                            <p className="text-3xl md:text-4xl lg:text-6xl text-white font-bold">PLAY HARD. LOOK GOOD.</p>
