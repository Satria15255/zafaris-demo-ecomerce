...
const OrderDetails = ({ order, handleCancel, handleConfirm }) => {
  ...
  return (
    <div className="p-2 md:p-4 ">
      {order.map((ord) => (
        <div key={ord._id} className="border mb-6 p-2 h-80 md:p-4 rounded-xl shadow space-y-3">
          ...
          <div className="flex h-full gap-4">
            ...
            {/* Order Information */}
            <div className="w-full h-full flex flex-col justify-around text-[10px] lg:text-sm">
              ...
              <div className="flex justify-end gap-1">
                <button
                  ...
                  className="text-[10px] md:text-md lg:text-lg border w-1/5 py-1 rounded-md font-bold hover:bg-gray-900 hover:text-white transition duration-300 disabled:opacity-50 
