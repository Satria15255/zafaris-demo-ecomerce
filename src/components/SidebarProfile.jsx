            ...
            <div className="mt-17 mr-10 rounded-3xl w-1/2 md:w-50 lg:w-1/5 h-70 lg:h-90 bg-white z-50 md:p-6 shadow-xl">
                <ul className="md:space-y-3">
                    <div>
                        ...
                        <h2 className="text-[15px] text-center md:text-sm lg:text-2xl font-bold pb-3 border-b border-gray-500"> Hello {user.name}!</h2>
                        <button onClick={() => handleNavigate("/dashboard?tab=profile")} className="flex font-bold items-center text-sm gap-2 hover:text-gray-300 py-2 px-1 mt-1">
                            <FaHome />
                            <span>Profile</span>
                        </button>
                        <button onClick={() => handleNavigate("/dashboard?tab=my-orders")} className="flex font-bold items-center text-sm gap-2 hover:text-gray-300 py-2 px-1 mt-1">
                            <FaCreditCard />
                            <span>My Orders</span>
                        </button>
