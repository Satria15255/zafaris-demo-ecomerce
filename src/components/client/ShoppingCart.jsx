                                ...
                                <table className="w-full border-collapse">
                                    <thead className="hidden md:table-header-group">
                                        <tr className="border-b">
                                            <th className="text-left text-xs pb-2">
                                                PRODUCT
                                            </th>
                                            <th className="text-center text-xs pb-2">
                                                QUANTITY
                                            </th>
                                            <th className="text-right text-xs pb-2">
                                                TOTAL
                                            </th>
                                        </tr>
                                    </thead>
                                                ...
                                                >
                                                    ...
                                                    <td className="flex items-center py-4 px-2">
                                                        <img
                                                            ...
                                                            className="w-25 h-25 md:w-20 md:h-20 lg:w-20 lg:h-20 object-cover rounded mr-1 md:mr-4"
                                                        />
                                                        <div>
                                                    ...
                                                    <td className="flex-col items-center text-center md:table-cell">
                                                        <div className="flex items-center justify-center">
                                                            <button
                                                                className="text-xs lg:text-sm px-2 py-1 border rounded"
                                                                onClick={() =>
                                                                    updateQty(
                                                                        item
                                                                            .productId
